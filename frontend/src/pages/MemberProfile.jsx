      ...
      <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: 20 }}>
        ...
        <div>
          <div className="card" style={{ marginBottom: 16 }}>
            <div style={{ height: 80, background: 'linear-gradient(135deg, #1A5F6A, #2A8A99)' }} />
            ...
            {[
              ...
              <div key={k} style={{
                ...
                padding: '8px 22px', borderTop: '1px solid rgba(0,0,0,0.05)',
                fontSize: '0.78rem',
              }}>
                <span style={{ color: '#7A7A6E' }}>{k}</span>
                <span style={{ fontWeight: 500, textAlign: 'right', maxWidth: 160, wordBreak: 'break-all' }}>{v}</span>
              </div>
            ))}
            {member.notes && (
