...
export default function Members() {
  ...
  const [deleteTarget, setDeleteTarget] = useState(null); // member id pending delete
  ...
  return (
    <div>
                      ...
                      <div style={{ display: "flex", gap: 6 }}>
                        ...
                        {m.status === "active" && (
                          <button
                            className="btn btn-outline btn-sm"
                            onClick={() =>
                              handleStatusChange(m._id, "suspended")
                            }
                          >
                            Suspend
                          </button>
      ...
      <ConfirmDialog
        open={!!deleteTarget}
        title="Delete Member"
        message="This will permanently delete the member and cannot be undone. Are you sure?"
        confirmLabel="Delete"
        danger
